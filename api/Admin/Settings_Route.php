...
class Settings_Route extends WP_REST_Controller  {
    ...
    public function get_items( $request ) {
        $response = [
            'ghlApiKey' => get_option( 'wpsm_settings_ghlApiKey', true ),
            'firstname' => get_option( 'wpsm_settings_firstname', true ),
            'lastname'  => get_option( 'wpsm_settings_lastname', true ),
            'email'     => get_option( 'wpsm_settings_email', true ),
        ];
    ...
    public function create_items( $request ) {
        ...
        // Data validation
        $ghlApiKey = isset( $request['ghlApiKey'] ) ? sanitize_text_field( $request['ghlApiKey'] ): '';
        ...
        update_option( 'wpsm_settings_ghlApiKey', $ghlApiKey );
        update_option( 'wpsm_settings_firstname', $firstname );
        update_option( 'wpsm_settings_lastname', $lastname );
        update_option( 'wpsm_settings_email', $email );
